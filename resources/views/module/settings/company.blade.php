				...
				<div class="card-block">
					<div class="row">
						<div class="col-xl-12">
                            ...
                            @if(isset($data))
                            <form name="Company" action="{{url('Settings/Company/Update/'.$data['id'])}}" method="post">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-lg-6">
                            ...
                            @else
							<form name="Company" action="{{url('Settings/Company/Add')}}" method="post">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="l30">Company Title</label>
                                            <input type="text" name="name" class="form-control" placeholder="Type Company Name" id="l30">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="l30">Address</label>
                                            <input type="text" name="address" class="form-control" placeholder="Type Address" id="l30">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="l30">Phone</label>
                                            <input type="text" name="phone" class="form-control" placeholder="Type Phone" id="l30">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="l30">Company Email</label>
                                            <input type="text" name="companyemail" class="form-control" placeholder="Type Email" id="l30">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="l30">HR Email</label>
                                            <input type="text" name="HRemail" class="form-control" placeholder="Type HR_Email" id="l30">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="l30">Leave Email</label>
                                            <input type="text" name="Leaveemail" class="form-control" placeholder="Type Leave_Email" id="l30">
                                        </div>
                                    </div>
                                     <div class="col-lg-6">
                                        <div class="form-group">
                            ...
                            <script type="text/javascript">
                                $(document).ready(function () {
                                    ...
                                    $("#grid").kendoGrid({
                                        ...
                                        {field: "address", title: "Company Address ", width: "80px"},
                                        {field: "phone", title: "Phone", width: "80px"},
                                        {field: "company_email", title: "Company Email ", width: "80px"},
                                        {field: "hr_email", title: "HR Email ", width: "80px"},
                                        {field: "leave_email", title: "Leave Email ", width: "80px"},
                                        {field: "company_logo", title: "Company Logo ", width: "80px"},
