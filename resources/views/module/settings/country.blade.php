			...
			<section class="card" order-id="card-1">
				<div class="card-header">
                    ...
                    <div class="pull-right cat__core__sortable__control">
                        <a href="{{route('settings.country.export.excel')}}" class="btn btn-success">Export Excel</a> 
                    </div>
							...
							<form name="Country" action="{{url('Settings/Country/Add')}}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="l30">Country Name</label>
                                            <input type="text" name="name" class="form-control" placeholder="Type Country" id="l30">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
