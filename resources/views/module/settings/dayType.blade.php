							...
							<form name="Daytype" action="{{url('Settings/Daytype/Add')}}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="l30">Day Title</label>
                                            <input type="text" name="name" class="form-control" placeholder="Type Day title" id="l30">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="l30">Day Short Code</label>
                                            <input type="text" name="day_short_code" class="form-control" placeholder="Type Day Short Code" id="l30">
                                        </div>
                                    </div>
